.. meta::
    :description lang=en: Python operating system tutorial covering file operations, datetime, process management, environment variables, and path manipulation
...
section covers essential OS operations including file manipulation, directory
